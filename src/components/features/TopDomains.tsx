  ...
  return (
    <Card variant="elevated" className="overflow-hidden">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-black/40 text-[10px] font-bold uppercase tracking-widest mt-1">{subtitle}</p>
          </div>
        </div>
        <button className="text-black/40 hover:text-black transition-all duration-300 p-2">
        ...
        {data.map((entry, index) => (
          <div key={index} className="flex items-center space-x-4 group hover:bg-white/5 p-4 border-b border-white/5 transition-all duration-300">
            ...
            <div className="flex items-center space-x-3 min-w-[60px]">
              <span className="text-black/20 text-[10px] font-bold uppercase tracking-widest">#{entry.rank}</span>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-3">
                <span className="text-black font-serif font-bold text-sm truncate tracking-tight">{entry.domain}</span>
                <span className="text-black font-serif font-bold text-sm ml-4">{entry.mentions}</span>
              </div>
      ...
      <div className="mt-6 pt-4 border-t border-white/10">
        <button className="text-black hover:underline text-xs font-bold uppercase tracking-widest transition-colors">
          View all domains →
        </button>
      </div>
    </Card>
