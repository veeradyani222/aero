      ...
      <div className="relative">
        ...
        <div className="flex items-center justify-center space-x-6 mt-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-black/60">ChatGPT</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-white"></div>
            <span className="text-[10px] font-bold uppercase tracking-widest text-black/60">Google AIO</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-white/40"></div>
            <span className="text-[10px] font-bold uppercase tracking-widest text-black/60">Perplexity</span>
          </div>
        </div>
      </div>
    );
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card variant="elevated" className="p-6">
        <div className="flex items-center space-x-3 mb-2">
          ...
          <h3 className="text-sm  font-bold text-black tracking-tight">Brand Visibility Trend</h3>
        </div>
        <p className="text-black/40 text-[10px] font-bold uppercase tracking-widest mb-8">
      ...
      <Card variant="elevated" className="p-6">
        <div className="flex items-center space-x-3 mb-2">
          ...
          <h3 className="text-sm  font-bold text-black tracking-tight">Link Visibility Trend</h3>
        </div>
        <p className="text-black/40 text-[10px] font-bold uppercase tracking-widest mb-8">
